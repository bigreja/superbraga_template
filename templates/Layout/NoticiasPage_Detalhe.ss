    ...
    <div class="blog-post">
               ...
               <div class="blog-post-header">
                  ...
                  <div class="blog-post-meta">
                    <time class="blog-post-time" datetime="2018"><span class="icon mdi mdi-clock"></span>{$Noticias.Created.ShortMonth} {$Noticias.Created.Format('d, Y')}</time>
                ...
                <img src="{$BaseHref}$Noticias.Imagem.Fill(683,407).Link" alt="" width="683" height="407">
                {$Content.RAW}
                </div>
